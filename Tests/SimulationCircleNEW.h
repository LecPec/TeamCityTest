#ifndef CPP_2D_PIC_SIMULATIONCIRCLENEW_H
#define CPP_2D_PIC_SIMULATIONCIRCLENEW_H
...
scalar debye_radius_new(scalar n_e, scalar n_ion, scalar T_e, scalar T_ion) {
...
void test_simulation_circle_new() {
    ...
    scalar r_d = debye_radius_new(n_e_scaled, n_i_scaled, T_e, T_i) * 2;
    cout << "dt_e = " << dt_e << endl;
    cout << "dt_i = " << dt_i << endl;
...
#endif //CPP_2D_PIC_SIMULATIONCIRCLENEW_H
